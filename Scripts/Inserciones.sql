...
--INSERTS 
Insert Into Estudiante (Nombre, Apellido1, Apellido2, Cedula, Contraseña)
Values  ('Jhonattan', 'Mora', 'Solano', 146321862, 'abc123'),
		('Bryan', 'Gonzalez', 'Blanco', 114930604, '123456'),
		('Sergio', 'Morales', 'Quiros', 125155565, 'a1b2c3'),
		('Sergio', 'Brenes', 'Perez', 156165164, '09876');
...
INSERT INTO Requisitos(Codigo_Curso, Requisitos)
VALUES  ('PGI01', ''), 
		('PG002', ''),
		('PE-01', ''),
		('PG003', ''),
		...
		('PE-60', 'PE-21'),
		('PE-30', 'PII08'),
		('PE-71', 'PE-30, PE-52, PE-60'),
		('PE-35', 'PE-30'),
		('PE-40', 'PE-52'),
		('PE-50', 'PE-30'),
		('PC-25', 'PE-35, PE-40, PE-50'),
		('PE-81', 'PE-35, PE-40, PE-50'),
		('PEL65', 'PE-50'),
		('PE-61', 'PE-40'),
		('PE-72', 'PC-25, PE-81'),
		('PE-62', 'PE-61'),
		('PE-63', 'PE-61'),
		('PEL61', 'PC-25, PE-61, PE-81'),
		('PE-65', 'PE-62, PE-63, PE-72'),
		('PE-64', 'PE-62, PE-63, PE-72'),
		('PE-66', 'PE-62, PE-63, PE-72'),
		('PC-27', 'PE-72, PGI03'),
		('TGPER1', ''),
		('PE-82', 'PC-27, PE-64, PE-65'),
		('PE-70', 'PC-27, PE-64, PE-65'),
		('PE-83', 'PC-27, PE-64, PE-6'),
		('PE-88', ''),
		('AE-10', ''),
		('IS-10', ''),
		('PMA01', ''),
		...
		('PII03', 'PII02'),
		('PII04', 'PII01'), 
		('SIS.INFO.II', 'SIS.INFO.I'),
		('TGINF1', ''),
		('IS-31', 'PII03, PII04, SIS.INFO.II'),
		('IS-35', 'SIS.INFO.II'),
		('IS-45', ''),
		('SIS.INFO.III', 'IS-29, IS-35, SIS.INFO.II'),
		('IS-38', 'IS-29');

Select * from Requisitos


INSERT INTO Horario(Codigo_Curso, Dia, Hora_ini, Hora_fin)
VALUES  ('PGI01', 'L', '18:00:00', '21:00:00'),
		('PG002', 'M', '15:00:00', '18:00:00'),
		('PE-01', 'J', '08:00:00', '11:00:00'),
		('PG003', 'K', '11:00:00', '14:00:00'),
		('HI-03', 'S', '14:00:00', '17:00:00'),
		('PGI02', 'V', '18:00:00', '21:00:00'),
		('PII08', 'M', '08:00:00', '11:00:00'),
		('PE-21', 'K', '15:00:00', '18:00:00'),
		('PE-52', 'J', '11:00:00', '14:00:00'),
		('PGI03', 'L', '08:00:00', '11:00:00'),
		('PE-60', 'V', '18:00:00', '21:00:00'),
		('PE-30', 'S', '11:00:00', '14:00:00'),
		('PE-71', 'K', '15:00:00', '18:00:00'),
		('PE-35', 'M', '11:00:00', '14:00:00'),
		('PE-40', 'L', '08:00:00', '11:00:00'),
		('PE-50', 'J', '15:00:00', '18:00:00'),
		('PC-25', 'V', '18:00:00', '21:00:00'),
		('PE-81', 'S', '14:00:00', '17:00:00'),
		('PEL65', 'L', '15:00:00', '18:00:00'),
		('PE-61', 'K', '18:00:00', '21:00:00'),
		('PE-72', 'J', '08:00:00', '11:00:00'),
		('PE-62', 'V', '11:00:00', '14:00:00'),
		('PE-63', 'L', '15:00:00', '18:00:00'),
		('PEL61', 'J', '08:00:00', '11:00:00'),
		('PE-65', 'K', '11:00:00', '14:00:00'),
		('PE-64', 'M', '18:00:00', '21:00:00'),
		('PE-66', 'S', '08:00:00', '11:00:00'),
		('PC-27', 'J', '15:00:00', '18:00:00'),
		('TGPER1', 'L', '18:00:00', '21:00:00'),
		('PE-82', 'M', '08:00:00', '11:00:00'),
		('PE-70', 'K', '18:00:00', '21:00:00'),
		('PE-83', 'J', '18:00:00', '21:00:00'),
		('PE-88', 'V', '15:00:00', '18:00:00'),
		('AE-10', 'S', '08:00:00', '11:00:00'),
		('IS-10', 'J', '18:00:00', '21:00:00'),
		('PMA01', 'M', '15:00:00', '18:00:00'),
		('PG333', 'L', '08:00:00', '11:00:00'),
		('AE-05', 'K', '11:00:00', '14:00:00'),
		('PGI99', 'J', '18:00:00', '21:00:00'),
		('MA-15', 'V', '15:00:00', '18:00:00'),
		('IS-11', 'K', '18:00:00', '21:00:00'),
		('MA-20', 'S', '08:00:00', '11:00:00'),
		('PAC03', 'L', '18:00:00', '21:00:00'), 
		('IS-21', 'M', '15:00:00', '18:00:00'),
		('IS-12', 'K', '11:00:00', '14:00:00'),
		('MA-25', 'V', '18:00:00', '21:00:00'),
		('PII01', 'J', '15:00:00', '18:00:00'),
		('IS28L', 'L', '18:00:00', '21:00:00'),
		('PII07', 'V', '18:00:00', '21:00:00'),
		('IS-23', 'K', '08:00:00', '11:00:00'),
		('PII06', 'M', '11:00:00', '14:00:00'),
		('AE-19', 'S', '14:00:00', '17:00:00'),
		('AE-25', 'L', '15:00:00', '18:00:00'),
		('IS-25', 'M', '18:00:00', '21:00:00'),
		('FI-05', 'K', '18:00:00', '21:00:00'),
		('PG001', 'J', '15:00:00', '18:00:00'),
		('IS-39', 'M', '08:00:00', '11:00:00'),
		('IS-26', 'L', '11:00:00', '14:00:00'),
		('PII02', 'V', '08:00:00', '11:00:00'),
		('IS-41', 'S', '08:00:00', '11:00:00'),
		('IS-36', 'V', '15:00:00', '18:00:00'),
		('SIS.INFO.I', 'L', '18:00:00', '21:00:00'),
		('IS-29', 'K', '15:00:00', '18:00:00'),
		('PII03', 'M', '11:00:00', '14:00:00'),
		('PII04', 'J', '11:00:00', '14:00:00'),
		('SIS.INFO.II', 'V', '18:00:00', '21:00:00'),
		('TGINF1', 'M', '15:00:00', '18:00:00'),
		('IS-31', 'K', '18:00:00', '21:00:00'),
		('IS-35', 'S', '11:00:00', '14:00:00'),
		('IS-45', 'L', '14:00:00', '17:00:00'),
		('SIS.INFO.III', 'J', '08:00:00', '11:00:00'),
		('IS-38', 'J', '08:00:00', '11:00:00');

Select * from Horario


INSERT INTO Expediente(Carnet)
VALUES	(1),
		(2),
		(3),
		(4);
...
--INSERT INTO InfoExpediente(IdExpediente, Codigo_Info)
--VALUES (1, )